...
(function() { this.JST || (this.JST = {}); this.JST["feeds/feeds_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1 id="welcome">Hello, ',  currentUsername ,'</h1>\r\n\r\n<header class="row"></header>\r\n\r\n<div class="row"></div>\r\n\r\n<div id="feed-list">\r\n    ');  feeds.each(function(feed) { ; __p.push('\r\n      <div class="feed-item-container" data-id="',  feed.id ,'" id="container-',  feed.id ,'">\r\n        <div class="unread-entry-count feed-', feed.id,'-unread-entry-count">',  feed.get('unread') ,'</div>\r\n        <div class="feed-item">\r\n          <div data-id="',  feed.id,'" class="feed-item-title">',  feed.get('title') ,'</div>\r\n          <span data-id="',  feed.id ,'" class="glyphicon glyphicon-refresh"></span>\r\n          <span data-id="',  feed.id ,'" class="glyphicon glyphicon-trash"></span>\r\n          <br>\r\n          <span class="feed-item-description">',  feed.get('description') ,'</span>\r\n        </div>\r\n      </div>\r\n      <div class="feed-break-line"></div>\r\n    ');  }) ; __p.push('\r\n</div>\r\n\r\n<div class="row"></div>\r\n\r\n<form method="POST" id="new-feed-form">\r\n  <div class="input-group">\r\n    <input type="text" class="form-control" name="feed[url]" placeholder="example.com/rss">\r\n    <span class="input-group-btn">\r\n      <button type="submit" class="btn btn-default" id="submit-new-feed-btn">\r\n        <span class="glyphicon glyphicon-plus-sign" id="submit-new-feed-icon"></span>  Add Feed\r\n      </button>\r\n    </span>\r\n  </div>\r\n</form>\r\n\r\n<div class="row"></div>\r\n\r\n<a href="/session" data-method="delete" id="logout-link"><button class="btn btn-default" id="logout-btn">Log Out</button></a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["feeds/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="feed-header">\n  <h1>\n    ',  feed.get('title') ,'\n    <input type="text" id="entry-search-box" placeholder="search">\n    ');  if (feed.entries().length < feed.get('unread')) { ; __p.push('\n      <button class="btn btn-default" id="reset-feed">Show All</button>\n    ');  } ; __p.push('\n  </h1>\n</div>\n\n<div id="row"></div>\n\n<div id="entry-list">\n  ');  feed.entries().each(function(entry) { ; __p.push('\n    ');  if (entry.get('read') === true) { ; __p.push('\n      <div class="feed-entry-bar entry-read" data-id="',  entry.id ,'">',  entry.get('title') ,'\n    ');  } else { ; __p.push('\n      <div class="feed-entry-bar" data-id="',  entry.id ,'">',  entry.get('title') ,'\n    ');  } ; __p.push('\n    <span class="feed-pubdate">',   moment.utc(entry.get('pubdate')).fromNow() ,'</span>\n    ');  if (entry.get('description')) { ; __p.push('\n      <div class="feed-entry-description">\n        ',  entry.get('content-encoded') || entry.get('description') ,'\n      </div>\n      <div class="feed-entry-hidden feed-entry-encoded-description">\n        <div></div>\n        <p><a href="',  entry.get('link') ,'">Click through</a></p>\n      </div>\n    ');  } ; __p.push('\n  </div>\n  ');  }) ; __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1 class="no-entry-selected-view">\n');  if (feeds.length === 0) { ; __p.push('\n  You don\'t currently have any feeds. Try adding one over on the left.\n  ');  } else { ; __p.push('\n    You currently have <strong>',  feeds.length ,'</strong> feeds consisting of <strong>',  totalUnread ,'</strong> unread items.\n    <br><br>\n    ');  if (totalUnread > 0) { ; __p.push('\n      <em>Better get to reading...</em>\n    ');  } else { ; __p.push('\n      <em> You little bookworm ;) </em>\n    ');  } ; __p.push('\n  ');  } ; __p.push('\n</h1>\n');}return __p.join('');};
}).call(this);
