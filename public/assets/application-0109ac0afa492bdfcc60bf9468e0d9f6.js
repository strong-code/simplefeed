...
(function() { this.JST || (this.JST = {}); this.JST["feeds/index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1 id="welcome">Hello, ',  username ,'</h1>\r\n\r\n<header class="row"></header>\r\n\r\n<div class="row"></div>\r\n\r\n<div id="feed-list">\r\n    ');  feeds.each(function(feed) { ; __p.push('\r\n      <div class="feed-item-container" id="container-',  feed.id ,'">\r\n        <div class="unread-entry-count">(',  feed.get('unread') ,')</div>\r\n        <div class="feed-item">\r\n          <span data-id="',  feed.id,'" class="feed-item-title">',  feed.get('title').substring(0,35) ,'</span>');  if (feed.get('title').length>35) { ; __p.push('...'); }; __p.push('\r\n          <span data-id="',  feed.id ,'" class="glyphicon glyphicon-refresh"></span>\r\n          <span data-id="',  feed.id ,'" class="glyphicon glyphicon-trash"></span>\r\n          <br>\r\n          <span class="feed-item-description">',  feed.get('description') ,'</span>\r\n        </div>\r\n      </div>\r\n    ');  }) ; __p.push('\r\n</div>\r\n\r\n<div class="row"></div>\r\n\r\n<form method="POST" id="new-feed-form">\r\n  <div class="input-group">\r\n    <input type="text" class="form-control" name="feed[url]" placeholder="example.com/rss">\r\n    <span class="input-group-btn">\r\n      <button type="submit" class="btn btn-default" id="submit-new-feed-btn">\r\n        <span class="glyphicon glyphicon-plus-sign" id="submit-new-feed-icon"></span>  Add Feed\r\n      </button>\r\n    </span>\r\n  </div>\r\n</form>\r\n\r\n<div class="row"></div>\r\n\r\n<button class="btn btn-default" id="logout-btn"><a href="/session" data-method="delete">Log Out</a></button>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["feeds/show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div id="row"></div>\n\n<div id="entry-list">\n  ');  feed.entries().each(function(entry) { ; __p.push('\n    <div class="feed-entry-bar" data-id="',  entry.id ,'">',  entry.get('title') ,'\n      <span class="feed-pubdate">',   entry.get('pubdate') ,'</span>\n      ');  if (entry.get('description')) { ; __p.push('\n        <div class="feed-entry-description">',  entry.get('content-encoded') || entry.get('description') ,'</div>\n        <div class="feed-entry-hidden feed-entry-encoded-description"></div>\n      ');  } ; __p.push('\n    </div>\n  ');  }) ; __p.push('\n</div>\n');}return __p.join('');};
}).call(this);
...
SimpleFeed.Views.ShowFeed = Backbone.View.extend({
  ...
  showOrHideEntry: function(e) {
    ...
    $(e.currentTarget.children[2]).html(derf)
  }
});
